import { Category } from "../models/datas.model.js";
...
class CategoryManager {
   ...
   getTasks(mode: string, keyword?: string, filter?: string[]) {
...
function handleCreateTask(event: Event, mode?: Task, index?: number) {
   ...
   const title = data.get(mode ? `modifyTaskTitle` : 'taskTitle') as string
